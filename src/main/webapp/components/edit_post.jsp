...
<div class="modal edit_post">
  <div class="modal-content">
    <h3 style="color: #134892;">Hey <%=HomeController.currentUser.getFirstName()%>, you can now edit your post 🖊</h3>
    <% if (HomeController.errorTag != null && HomeController.errorTag.equals(Commons.noChangesInPostContentError)) { %>
      <div style="
        ...
        <p style="
            ...
            margin-block-end: 0;
        ">Post content has no changes to commit. Cancel or update the beatings of your heart content!</p>
      </div>
    <% } %>
    <label class="input-container">
      <textarea
        class="editPostInput"
        name="<%=Commons.editPost%>"
        form="editPostForm"
        placeholder="">
      </textarea>
    </label>
    <form action="home" method="post" name="editPostForm" id="editPostForm">
      <input type="hidden" name="<%=Commons.editPostId%>" class="editPostInputId">
