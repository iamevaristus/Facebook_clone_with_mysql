...
<c:choose>
    <c:when test="${empty HomeController.profilePosts or HomeController.profilePosts.size() == 0}">
        <div style="padding: 225px 50px">
            <h2 style="font-size: 50px; text-align: center">🫣</h2>
            <p style="text-align: center"><%= HomeController.profile.getFirstName()%>, start sharing your fun!</p>
        </div>
    </c:when>
    <c:otherwise>
        <c:forEach items="${HomeController.profilePosts}" var="post">
            <div style="border: 6px solid lavender; border-radius: 15px; padding: 10px; margin-bottom: 10px">
                <div style="display: flex; justify-content: space-between; align-items: center">
                    <div style="display: flex; align-items: center">
                        <div style="
                            ...
                            margin-right: 10px;
                        ">
                            <h4 style="font-size: 25px; text-align: center; margin: 0;">${post.postedByAvatar}</h4>
                        </div>
                ...
                <p style="font-size: 18px; margin-top: 20px; margin-bottom: 30px">${post.post}</p>
                <div class="info">
                        <%-- Like Section --%>
                    <c:choose>
                ...
                <div class="like">
                    <form action="home" method="post">
                        ...
                        <c:choose>
                            <c:when test="${post.likedByCurrentUser}">
                                <button type="submit" class="dis_like_icon like-button"><i class="fa-solid fa-thumbs-up"></i></button>
                            </c:when>
                            <c:otherwise>
                                <button type="submit" class="dis_like_icon"><i class="fa-solid fa-thumbs-up"></i></button>
                            </c:otherwise>
                        </c:choose>
                    </form>
                    ...
                    <c:choose>
                        <c:when test="${post.postedByCurrentUser}">
                            <!--///TODO:: --> <div class="dis_like_icon edit-button open_edit_post"
                                                ...
                                                <form action="home" method="post">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${comment.likedByCurrentUser}">
                                                            <button type="submit" class="comment_like_icon like-button"><i class="fa-solid fa-thumbs-up"></i></button>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <button type="submit" class="comment_like_icon"><i class="fa-solid fa-thumbs-up"></i></button>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </form>
                                                <c:choose>
                                                    <c:when test="${comment.commentedByCurrentUser}">
                                                <!--///TODO:: --> <div class="comment_like_icon edit-button open_edit_comment"
                                                        ...
                                                        <form action="home" method="post">
                                                            ...
                                                            <button type="submit" class="comment_like_icon delete-button"><i class="fa-solid fa-trash"></i></button>
                                                        </form>
                                                    </c:when>
                                                </c:choose>
                                            </div>
